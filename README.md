...
项目以 `Tsinghua ShortVideo Dataset` 的抽样数据为基础，最终形成 129,483 条清洗后交互，覆盖 6,654 名用户、31,496 个视频和 36 个一级主题，并在 101,690 条训练交互与 27,793 条测试交互上完成主题行为分析、用户画像构建、关联规则挖掘和推荐策略对比评估。
